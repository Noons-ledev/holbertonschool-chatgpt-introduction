...
def factorial(n):
    ...
    Raises:
    - RecursionError: If the recursion depth exceeds the maximum limit (unlikely with small numbers).
    """
    if n == 0:
...
# sys.argv is a list where sys.argv[0] is the script name, and sys.argv[1] is the first command-line argument.
...
try:
    ...
    print("Error: No argument provided. Please provide a number to calculate the factorial.")
except ValueError:
